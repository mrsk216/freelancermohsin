...
export default function Home({ projects, whyBestArray }) {
    //Changes Words
    const words = [
    ...
    return (
        <AppLayout>
            ...
            <section className='w-full bg-[#ffffffd4] bg-[url("/assets/images/bg/strategy.jpg")] bg-no-repeat bg-blend-overlay bg-fixed bg-cover bg-center flex items-center relative'>
                <div className="w-full lg:w-10/12 xl:w-8/12 h-full grid gap-8 mx-auto px-4">
                    <div className="flex justify-center mb-8">
                        <div className="w-full md:w-8/12 lg:w-7/12 text-center">
                    ...
                    <div className="w-full my-5">
                        <div className="grid grid-cols-12 justify-center gap-5 mb-5 mb-lg-0">
            ...
            <section id="whyUs" className="w-full py-5 bg-[#ffffff5c] bg-no-repeat flex items-center">
                <div className="w-full lg:w-10/12 xl:w-8/12 h-full grid gap-8 mx-auto px-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 my-5">
                        ...
                        <div className="w-full">
                            {whyBestArray?.map((whyBestItem: { icon: string; title: string; description: string }, i: number) => (
                                <div key={i} className="flex items-center gap-4 mb-4">
                                    <div className="bg-primary text-white w-40 h-16 flex justify-center items-center relative">
                                        <DynamicIcon iconName={whyBestItem.icon} classes={'hidden'}/>
                                    </div>
                                    <div className="content">
                                        <h4 className="font-bold title-color mb-2">{whyBestItem.title}</h4>
